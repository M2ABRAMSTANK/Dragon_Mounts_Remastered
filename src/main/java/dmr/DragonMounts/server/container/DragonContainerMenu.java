...
public class DragonContainerMenu extends AbstractContainerMenu {
    ...
    public DragonContainerMenu(int pContainerId, Inventory pPlayerInventory, FriendlyByteBuf data) {
        ...
        dragon = (TameableDragonEntity) pPlayerInventory.player.level.getEntity(data.readInt());
        if (dragon == null) {
        ...
        this.addSlot(new Slot(equipmentView, DragonInventory.CHEST_SLOT, 138, 18) {
            ...
            public void set(ItemStack pStack) {
                ...
                for (DragonInventorySlot slot : inventorySlots) {
                    slot.setChestTypeChanged(dragon.getInventory()
                            .getItem(DragonInventory.CHEST_SLOT)
                            .is(Items.ENDER_CHEST));
                }
            }
    ...
    public boolean stillValid(Player pPlayer) {
        return (!this.dragon.hasInventoryChanged(this.dragonContainer)
